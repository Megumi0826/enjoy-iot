...
INSERT INTO infra_file_config  VALUES (22, '七牛存储器（示例）', 20, '请换成你自己的密钥！！！', '0', '{"@class":"com.enjoyiot.module.infra.framework.file.core.client.s3.S3FileClientConfig","endpoint":"s3.cn-south-1.qiniucs.com","domain":"http://test.enjoy-iot.cn","bucket":"ENJOY","accessKey":"REPLACE_WITH_QINIU_ACCESS_KEY","accessSecret":"REPLACE_WITH_QINIU_ACCESS_SECRET"}', '1', '2024-01-13 22:11:12', '1', '2025-02-20 21:29:45', '0');
INSERT INTO infra_file_config  VALUES (24, '腾讯云存储（示例）', 20, '请换成你的密钥！！！', '0', '{"@class":"com.enjoyiot.module.infra.framework.file.core.client.s3.S3FileClientConfig","endpoint":"https://cos.ap-shanghai.myqcloud.com","domain":"http://tengxun-oss.enjoy-iot.cn","bucket":"aoteman-1255880240","accessKey":"REPLACE_WITH_TENCENT_ACCESS_KEY","accessSecret":"X"}', '1', '2024-11-09 16:03:22', '1', '2025-02-20 21:29:45', '0');
INSERT INTO infra_file_config  VALUES (25, '阿里云存储（示例）', 20, '', '0', '{"@class":"com.enjoyiot.module.infra.framework.file.core.client.s3.S3FileClientConfig","endpoint":"oss-cn-beijing.aliyuncs.com","domain":"http://ali-oss.enjoy-iot.cn","bucket":"ENJOY","accessKey":"REPLACE_WITH_ALIYUN_ACCESS_KEY","accessSecret":"X"}', '1', '2024-11-09 16:47:08', '1', '2025-02-20 21:29:45', '0');
INSERT INTO infra_file_config  VALUES (26, '火山云存储（示例）', 20, '', '0', '{"@class":"com.enjoyiot.module.infra.framework.file.core.client.s3.S3FileClientConfig","endpoint":"tos-s3-cn-beijing.volces.com","domain":null,"bucket":"ENJOY","accessKey":"REPLACE_WITH_VOLCENGINE_ACCESS_KEY","accessSecret":"X=="}', '1', '2024-11-09 16:56:42', '1', '2025-02-20 21:29:45', '0');
INSERT INTO infra_file_config  VALUES (27, '华为云存储（示例）', 20, '', '0', '{"@class":"com.enjoyiot.module.infra.framework.file.core.client.s3.S3FileClientConfig","endpoint":"obs.cn-east-3.myhuaweicloud.com","domain":"","bucket":"enjoy-iot","accessKey":"REPLACE_WITH_HUAWEI_ACCESS_KEY","accessSecret":"X"}', '1', '2024-11-09 17:18:41', '1', '2025-02-20 21:29:45', '0');
...
-- @formatter:off
BEGIN;
INSERT INTO system_sms_channel  VALUES (2, 'Ballcat', 'ALIYUN', 0, '你要改哦，只有我可以用！！！！', 'REPLACE_WITH_SMS_ACCESS_KEY', 'REPLACE_WITH_SMS_ACCESS_SECRET', NULL, '', '2021-03-31 11:53:10', '1', '2024-08-04 08:53:26', '0');
INSERT INTO system_sms_channel  VALUES (4, '测试渠道', 'DEBUG_DING_TALK', 0, '123', 'REPLACE_WITH_DINGTALK_WEBHOOK_TOKEN', 'REPLACE_WITH_DINGTALK_SECRET', NULL, '1', '2021-04-13 00:23:14', '1', '2022-03-27 20:29:49', '0');
