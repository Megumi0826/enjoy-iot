...
本项目是在 `enjoyiot` 乐联开源物联网平台基础上进行二次开发，结合毫米波雷达设备、小程序端设备绑定、实时监测和睡眠健康报告等业务场景，对会员端接口、实时推送链路、设备历史数据能力和项目说明进行了定制化扩展。
...
<table>
  <tr>
    <td align="center">
      <img src="./_docs/e0be63805ad4c144da6bcb3fa2c9d034.png" alt="系统预览一" width="420" />
      <br />
      <sub>系统预览一</sub>
    </td>
    <td align="center">
      <img src="./_docs/fc80c413bf9bb9fc6a1f05887e9eb7f6.png" alt="系统预览二" width="420" />
      <br />
      <sub>系统预览二</sub>
    </td>
  </tr>
